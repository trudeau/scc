package org.nnsoft.trudeau.scc;
...
import static org.nnsoft.trudeau.scc.SccSolver.findStronglyConnectedComponent;
...
public final class KosarajuSharirTestCase
{
    ...
    public void verifyHasStronglyConnectedComponents()
    {
        ...
        DirectedMutableGraph<BaseLabeledVertex, BaseLabeledEdge> graph =
            populate( new DirectedMutableGraph<BaseLabeledVertex, BaseLabeledEdge>() )
